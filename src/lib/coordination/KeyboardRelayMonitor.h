...
public:
  ...
  //! Returns true when the key was forwarded to the mesh (hook may swallow).
  using KeyForwardSend = std::function<
      bool(Message::KeyPhase phase, KeyID id, KeyModifierMask mask, KeyButton button, const std::string &lang)>;
